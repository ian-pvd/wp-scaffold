...
function get_asset_info( $slug, $attribute = null ) {
	if ( file_exists( ROUNDHOUSE_THEME_PATH . 'dist/js/' . $slug . '.asset.php' ) ) {
		$asset = require ROUNDHOUSE_THEME_PATH . 'dist/js/' . $slug . '.asset.php';
	} elseif ( file_exists( ROUNDHOUSE_THEME_PATH . 'dist/css/' . $slug . '.asset.php' ) ) {
		$asset = require ROUNDHOUSE_THEME_PATH . 'dist/css/' . $slug . '.asset.php';
	} else {
		return null;
	}
